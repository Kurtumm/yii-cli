...
/**
 * Bootstrap3Command creates an Yii Web application at the specified location.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.cli.commands
 * @since 1.0
 */
class Bootstrap3Command extends CConsoleCommand
{
	private $_rootPath;
...
EOD;
	...
	{
		return realpath(dirname(__FILE__).'/../views/bootstrap3');
	}
